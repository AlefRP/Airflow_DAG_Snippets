...
# @task_group(add_suffix_on_collision=True)
...
def process_tasks(partner_settings, group_name):
    with TaskGroup(group_id=group_name, add_suffix_on_collision=True) as process_tasks:
